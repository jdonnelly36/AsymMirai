...
class Test_state_keeping(unittest.TestCase):
    ...
    @pytest.mark.skip(reason="Filesystem layout is OS dependent")
    def test_simple_model(self):
        ...
        state_keeper.save({'resnet': self.model}, {'resnet': self.optimizer}, {'resnet': self.epoch}, {'resnet': self.lr}, {'resnet': self.epoch_stats})
